...
public class LorawanDevice {
  ...
  public static Preset preset(){
    return PresetBuilder.builder().type(MeterType.LORAWAN).level(Level.DEVICE).constraints(constraints()).build();
  }
...
var f =  new ArrayList<>(List.of(devEui, appEui, appKey, deviceProfileId, serviceProfileId, awsId));
