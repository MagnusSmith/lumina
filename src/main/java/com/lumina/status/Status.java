...
public sealed interface Status permits Status.Lorawan, Status.Modbus {
  record Lorawan(String id, String meterId, LocalDateTime lastCommunication, SignalStrength.Lorawan signalStrength, double batteryLevel) implements Status {}

  record Modbus(String id, String meterId, LocalDateTime lastCommunication, SignalStrength.Modbus signalStrength) implements Status {}
